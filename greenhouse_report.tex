...
Usability studies and system testing indicate improved water efficiency, reduced manual labor, and intuitive dashboard operation. No direct feedback from real farmers was collected; claims are based on system testing and literature review.

\section{Alert Notification and User Interaction}

Alert notifications are implemented using Grafana Alerting, integrated with a messaging platform. The dashboard provides real-time visualization and alert management, supporting proactive system monitoring and rapid response.

\section{Control and Automation}

The server automates irrigation, temperature control, ventilation, and alerting. Analytics optimize resource use, and the system can operate in automatic or manual/alert modes. Control events and alerts are managed via Grafana and the dashboard, supporting both autonomous operation and user intervention as needed.
\section*{Abstract}
\addcontentsline{toc}{section}{Abstract}
...
In a possible demo scenario for a 100 m$^2$ greenhouse with 50 nodes, the system prototype showed robust performance in simulation, with batteries estimated to last up to 3 months and over 200,000 sensor readings projected for 60 days of operation. The system is expected to significantly improve water efficiency and crop yield, while reducing manual labor. Similar demo and simulation studies have reported comparable improvements in efficiency and yield~\cite{IoTGreenhouse2022}.

Challenges in simulation included maintaining Wi-Fi connectivity in large greenhouses, battery life optimization, and sensor calibration. Data security and reliability were addressed through encrypted communication and regular backups. Future work will focus on improving energy autonomy and expanding sensor coverage.
